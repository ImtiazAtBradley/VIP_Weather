        ...
        <>
            <div className={`flex flex-col mt-12 ${RedHatDisplay.className}`}>
                ...
                <div className="text-center shadow-lg rounded border border-gray-200 mt-5 p-5">
                    ...
                    <div className="p-6">
                        <p className="text-lg">
                            Vertically Integrated Projects is a class within Bradley's Electrical Engineering department responsible for the development and maintenance of the BECC Weather Station. Vertically Integrated Projects (or VIP)
