...
import LoadFailedCard from "./ui/load-failed-card.tsx";
...
function Charts({time, temperature, humidity, pressure}) {
  return (
...
export default async function Page() {
  ...
  let currentTemp = weatherData.temp_c.slice(-1)
  let currentPressure = weatherData.pressure_kpa.slice(-1)
  let currentHumidity = weatherData.humidity_prcnt.slice(-1)
